...
import brandImg2 from '../../images/test.jpg';
import {
    ListItem,
    ListVariant,
    LoginFooterItem,
...
export const Login: React.FunctionComponent = () => {
    ...
    const [formUser, setFormUser] = React.useState<string | undefined>(user)
    ...
    const onLoginButtonClick = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        setIsValidUsername(!!formUser);
        setIsValidPassword(!!password);
        setShowHelperText(!formUser || !password);
        setUser(formUser)
    };
    ...
    const signUpForAccountMessage = (
        <LoginMainFooterBandItem>
            Need an account? <a href="src/components/LoginPage/Login#">Sign up.</a>
        </LoginMainFooterBandItem>
    );

    const forgotCredentials = (
        <LoginMainFooterBandItem>
            <a href="src/components/LoginPage/Login#">Forgot username or password?</a>
        </LoginMainFooterBandItem>
    );
    ...
    const loginForm = (
        <LoginForm
            ...
            usernameValue={formUser}
            onChangeUsername={setFormUser}
            ...
            isLoginButtonDisabled={formUser === undefined || formUser === ''}
        />
    );
    ...
    return (
        <LoginPage
            ...
            backgroundImgSrc={brandImg2}
            footerListItems={listItem}
            textContent="This is placeholder text only. Use this area to place any information or introductory message about your application that may be relevant to users."
            loginTitle="Log in to your account"
            loginSubtitle="Enter your SaaSi user credentials."
